  ...
  return (
    <>
      ...
      <section className="relative w-full h-screen">
        ...
        />
        <div className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center space-y-2">
          <h1 className="text-white/90 text-3xl md:text-5xl text-center font-extrabold font-libreBaskerville">
            Good Product, Good Life
          </h1>
          <h1 className="text-white/90 text-sm md:text-base text-center font-poppins">
      ...
      <section className="py-20 leading-relaxed bg-primary-bgColor/90">
        <div className="space-y-10">
          ...
          />
          <div className="flex items-centers overflow-x-scroll gap-7 scrollbar-none px-20">
            <ProductBox
