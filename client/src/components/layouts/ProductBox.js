...
const ProductBox = ({
    ...
    return (
        <div
            className={`bg-primary-bgColor/50 hover:bg-primary-bgColor/60 text-theme-text p-10 rounded-3xl flex flex-col items-center justify-center min-w-60 h-80 space-y-5 cursor-pointer ${className}`}
            {...props}
        >
